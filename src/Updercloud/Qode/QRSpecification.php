...
class QRSpecification
{
    ...
    public static function putAlignmentMarker(array &$frame, $ox, $oy)
    {
        ...
        for ($y = 0; $y < 5; $y++) {
            QRString::set($frame, $xStart, $yStart + $y, $finder[$y]);
        }
    }
    ...
    public static function putFinderPattern(&$frame, $ox, $oy)
    {
        ...
        for ($y = 0; $y < 7; $y++) {
            QRString::set($frame, $ox, $oy + $y, $finder[$y]);
        }
    }
    ...
    public static function createFrame($version)
    {
        ...
        QRString::set($frame, 0, 7, $setPattern);
        QRString::set($frame, $width - 8, 7, $setPattern);
        QRString::set($frame, 0, $width - 8, $setPattern);

        $setPattern = str_repeat("\x84", 9);
        QRString::set($frame, 0, 8, $setPattern);
        QRString::set($frame, $width - 8, 8, $setPattern, 8);
